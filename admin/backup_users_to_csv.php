...
$filename = "/content/HostingPlus/p/e/peterheylin.com/subdomains/demo/web/footfall/footfallcrm/1.6/backups/users_table_".date ("d-m-Y G:i").".csv";
...
<body>
<center>
<h2>Backup of users table successful</h2>
<?php
