...
$filename = "/content/Hosting/f/o/footfall.ie/web/crm/exports/fclients_table_".date ("d-m-Y G:i").".csv";
...
$query="SELECT * FROM company_fclients";
...
<body>
<center>
<h2>Backup of fclients table successful</h2>
<?php
