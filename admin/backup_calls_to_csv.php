...
$filename = "/content/HostingPlus/p/e/peterheylin.com/subdomains/demo/web/footfall/footfallcrm/1.6/backups/calls_table_".date ("d-m-Y G:i").".csv";
...
$query="SELECT * FROM contact_calls";
...
<body>
<center>
<h2>Backup of calls table successful</h2>
<?php
