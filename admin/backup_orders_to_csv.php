...
$filename = "/content/HostingPlus/p/e/peterheylin.com/subdomains/demo/web/footfall/footfallcrm/1.6/backups/orders_table_".date ("d-m-Y G:i").".csv";
...
$query="SELECT * FROM contact_orders";
...
<body>
<center>
<h2>Backup of orders table successful</h2>
<?php
