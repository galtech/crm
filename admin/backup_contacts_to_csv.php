...
$filename = "/content/HostingPlus/p/e/peterheylin.com/subdomains/demo/web/footfall/footfallcrm/1.6/backups/contacts_table_".date ("d-m-Y G:i").".csv";
...
<body>
<center>
<h2>Backup of contacts table successful</h2>
<?php
