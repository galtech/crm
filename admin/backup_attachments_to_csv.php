...
$filename = "/content/HostingPlus/p/e/peterheylin.com/subdomains/demo/web/footfall/footfallcrm/1.6/backups/attachments_table_".date ("d-m-Y G:i").".csv";
...
$query="SELECT * FROM contact_files";
...
<body>
<center>
<h2>Backup of attachments table successful</h2>
<?php
