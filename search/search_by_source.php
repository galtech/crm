...
$query = "SELECT * FROM company WHERE company.source = '$source' ORDER BY company";
...
<b><center>Source Search Results</center></b><br><br>
...
$source=mysql_result($result,$j,"source");
