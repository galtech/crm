...
$trimmed = trim($companystatus); // trim whitespac from stored variable
...
$query = "SELECT * FROM company WHERE status LIKE \"%$companystatus%\" ORDER BY company";
...
?>
<br /><br />
<a href="../add/add_company.php?id=<?echo $uid;?>">Required company not found, would you like to add it now?</a>
<br /><br />
<div>
<div id="footer">
<br />
