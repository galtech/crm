...
$companylocation = @$_GET['companylocation'];
$trimmed = trim($companylocation); // trim whitespace from stored variable
...
$query = "SELECT * FROM company WHERE county LIKE \"%$companylocation%\" ORDER BY company";
