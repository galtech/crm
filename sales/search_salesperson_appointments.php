...
$date_from = $_POST['appsearchfrom'];
$date_to = $_POST['appsearchto'];
...
$query = "SELECT * FROM contact_calls,company WHERE contact_calls.companyid = company.cid AND salesperson LIKE \"%$salesperson%\" AND contact_calls.date BETWEEN '$format_date_from' AND '$format_date_to' AND appointmentcheck = 'Yes' ORDER BY contact_calls.date DESC";
...
<th><font face="Arial, Helvetica, sans-serif" size="2">Appointment Secured</font></th>
</tr>
...
<td><font face="Arial, Helvetica, sans-serif"><a href="../view/view_company.php?id=<? echo $companyid;?>&amp;uid=<?echo $uid;?>"><? echo $company_company; ?></a></font></td>
