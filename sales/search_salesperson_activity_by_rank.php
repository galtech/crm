...
$selected_rank = $_POST['selectedrank'];
...
$query = "SELECT * FROM contact_calls,company WHERE contact_calls.companyid = company.cid AND salesperson LIKE \"%$salesperson%\" AND contact_calls.date BETWEEN '$format_date_from' AND '$format_date_to' AND contact_calls.rank = '$selected_rank' ORDER BY contact_calls.date DESC";
