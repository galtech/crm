...
$query = "SELECT * FROM contact_calls,company WHERE contact_calls.companyid = company.cid AND salesperson LIKE \"%$salesperson%\" AND contact_calls.date BETWEEN '$format_date_from' AND '$format_date_to' AND company.county LIKE \"%$selected_location%\" ORDER BY contact_calls.date DESC";
