...
$date_from = $_POST['upcomingdatefrom'];
$date_to = $_POST['upcomingdateto'];
...
$query = "SELECT * FROM contact_calls,company WHERE contact_calls.companyid = company.cid AND contact_calls.salesperson LIKE \"%$salesperson%\" AND contact_calls.callbackdate BETWEEN '$format_date_from' AND '$format_date_to' ORDER BY contact_calls.callbackdate ASC";
...
<b><center>Upcoming Calls</center></b><br/>
...
<th><font face="Arial, Helvetica, sans-serif" size="2">Telephone</font></th>
...
<td><font face="Arial, Helvetica, sans-serif" size="2"><? echo $company_tel; ?></font></td>
