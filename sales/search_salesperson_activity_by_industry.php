...
$date_from = $_POST['activitydatefrombyrank'];
$date_to = $_POST['activitydatetobyrank'];
$selected_industry = $_POST['selectedindustry'];
...
$query = "SELECT * FROM contact_calls,company WHERE contact_calls.companyid = company.cid AND salesperson LIKE \"%$salesperson%\" AND contact_calls.date BETWEEN '$format_date_from' AND '$format_date_to' AND company.indsec = '$selected_industry' ORDER BY contact_calls.date DESC";
